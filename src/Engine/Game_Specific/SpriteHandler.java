...
public class SpriteHandler {
    ...
    private Sprite spaceShip, secret, spaceShipShield;
    ...
    public SpriteHandler(ModelHandler modelHandler) {
        ...
        secretSetup();
        spaceShipShield = new Sprite(modelHandler.getProjectile());
        spaceShipShieldSetup();
    }

    private void spaceShipShieldSetup() {
        spaceShipShield.translate(spaceShipShield.getPosition().x, spaceShipShield.getPosition().y, spaceShipShield.getPosition().z);
        spaceShipShield.color = new Vector4f(0, 0, 1, 0.5f);
    }
    ...
    public Sprite getSpaceShipShield() {
